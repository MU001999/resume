...
Extensible interpreted programming language, consistent with Turing's complete thinking
...
Extended regular expression engine constructed using NFA
\begin{onehalfspacing}
\begin{itemize}
  \item Supports standard regular expression syntax
  \item Supports forward/reverse look-ahead, anonymous/named capture, naming check, etc. extended syntax
  \item API style is good, easy to understand and use
\end{itemize}
\end{onehalfspacing}
